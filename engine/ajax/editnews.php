...
HTML;
	...
	$row = $db->super_query( "SELECT id, date, xfields, title, category, short_story, full_story, autor FROM " . PREFIX . "_post where id = '$id'" );
	...
	$db->query( "UPDATE " . PREFIX . "_post_extras SET related_ids='', editdate='$added_time', editor='{$member_id['name']}', reason='$editreason', view_edit='$view_edit' WHERE news_id = '$id'" );
